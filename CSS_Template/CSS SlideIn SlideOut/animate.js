...
var $cssSlideInLeft = 'slideInLeft';
var $cssSlideOutLeft = 'slideOutLeft';

function frame01In() {
    fadeInOut({ id: "copy1", aniName: $cssSlideInLeft, duration: $duration, ease: easeInQuad });
}

function frame01Out() {
    fadeInOut({ id: "img1", aniName: $cssFadeOut, duration: $duration, delay: $delay, ease: easeInQuad });
    // fadeInOut({ id: "copy1", aniName: $cssFadeOut, duration: $duration, ease: easeInQuad });
    fadeInOut({ id: "copy1", aniName: $cssSlideOutLeft, duration: $duration, ease: easeInQuad });
}

function frame02In() {
    fadeInOut({ id: "img2", aniName: $cssFadeIn, duration: $duration, ease: easeInQuad });
    fadeInOut({ id: "copy2", aniName: $cssSlideInLeft, duration: $duration, delay: $delay, ease: easeInQuad });
}

function frame02Out() {
    fadeInOut({ id: "img2", aniName: $cssFadeOut, duration: $duration, delay: $delay, ease: easeInQuad });
    // fadeInOut({ id: "copy2", aniName: $cssFadeOut, duration: $duration, ease: easeInQuad });
    fadeInOut({ id: "copy2", aniName: $cssSlideOutLeft, duration: $duration, ease: easeInQuad });
}

function frame03In() {
    fadeInOut({ id: "img3", aniName: $cssFadeIn, duration: $duration, ease: easeInQuad });
    fadeInOut({ id: "copy3", aniName: $cssSlideInLeft, duration: $duration, delay: $delay, ease: easeInQuad });
}

function frame03Out() {
    fadeInOut({ id: "img3", aniName: $cssFadeOut, duration: $duration, delay: $delay, ease: easeInQuad });
    // fadeInOut({ id: "copy3", aniName: $cssFadeOut, duration: $duration, ease: easeInQuad });
    fadeInOut({ id: "copy3", aniName: $cssSlideOutLeft, duration: $duration, ease: easeInQuad });
...
function lastFrameOut() {
    ...
    fadeInOut({ id: "img1", aniName: $cssFadeIn, duration: $duration, delay: 0.5, ease: easeInQuad });
    fadeInOut({ id: "logo", aniName: $cssFadeIn, duration: $duration, delay: 0.5, ease: easeInQuad });
}
