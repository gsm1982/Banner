...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-1.7,29.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer 1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#133C7D").s().p("AzlEsQhfAAAAhfIAAmZQAAhfBfAAMAnLAAAQBfAAAABfIAAGZQAABfhfAAg");
	this.shape_1.setTransform(-1.6,29.1);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(-136.5,-0.9,269.8,60.1), null);
...
(lib.LogoAnimation = function(mode,startPosition,loop) {
	...
	this.nbn.setTransform(181.8,49.9,1.065,1.065,0,0,0,58.1,20.8);
	this.nbn.alpha = 0;
	...
	this.NBNlogo.setTransform(234.5,39.9,0.37,0.37,0,0,0,68.8,68.1);
	...
	this.NBNtrail.setTransform(264.8,29,0.506,0.506,0,0,0,8,28.4);
	...
	this.instance.parent = this;
	this.instance.setTransform(494.5,15.6);
...
p.nominalBounds = new cjs.Rectangle(483.6,59.3,138.6,58.6);
// library properties:
lib.properties = {
