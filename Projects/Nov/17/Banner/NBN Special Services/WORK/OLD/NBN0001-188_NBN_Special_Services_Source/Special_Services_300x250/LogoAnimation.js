...
(lib.LogoAnimation = function(mode,startPosition,loop) {
	...
	this.nbn.setTransform(140.2,103.8,1.464,1.464,0,0,0,58.1,20.7);
	this.nbn.alpha = 0;
	...
	this.NBNlogo.setTransform(212.5,90,0.509,0.509,0,0,0,68.5,67.8);
	...
	this.NBNtrail.setTransform(254.2,75.2,0.695,0.695,0,0,0,7.9,28.4);
