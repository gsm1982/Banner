(function (cjs, an) {
    ...
    (lib.cta = function(mode,startPosition,loop) {
        ...
        // Layer 3
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#FFFFFF").s().p("");
        this.shape.setTransform(-2.5,40.1);
    ...
    (lib.LogoAnimation = function(mode,startPosition,loop) {
        ...
        this.nbn.setTransform(91.3,53,1,1,0,0,0,58,20.5);
        this.nbn.alpha = 0;
        ...
        this.NBNlogo.setTransform(140.7,43.7,0.347,0.347,0,0,0,68.2,67.7);
        ...
        this.NBNtrail.setTransform(169.2,33.6,0.475,0.475,0,0,0,7.8,28.2);
