...
(lib.nbn = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(103.3,34.6,2.55,2.55);
	...
	this.shape_1.setTransform(89.6,34.6,2.55,2.55);
	...
	this.shape_2.setTransform(75.3,34.4,2.55,2.55);
	...
	this.shape_3.setTransform(59.3,34.6,2.55,2.55);
	...
	this.shape_4.setTransform(47.1,34.6,2.55,2.55);
	...
	this.shape_5.setTransform(36.3,34.6,2.55,2.55);
	...
	this.shape_6.setTransform(21.4,34.7,2.55,2.55);
	...
	this.shape_7.setTransform(5.8,34.4,2.55,2.55);
	...
	this.shape_8.setTransform(42,13.5,1.877,1.877);
	...
	this.shape_9.setTransform(25.1,10.7,1.877,1.877);
	...
	this.shape_10.setTransform(7.6,13.5,1.877,1.877);
	...
	this.shape_11.setTransform(51,3.4,1.877,1.877);
	...
	this.shape_12.setTransform(47.6,3.4,1.877,1.877);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.nbn, new cjs.Rectangle(0.6,-0.3,107.6,41.7), null);
...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-5.4,40.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(-5.6,58.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	// Layer 3
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#133C7D").s().p("ApvEhQhkAAAAhkIAAl5QAAhkBkAAITfAAQBkAAAABkIAAF5QAABkhkAAg");
	this.shape_2.setTransform(-5.1,50.2);

	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(-77.4,21.4,144.8,57.7), null);
...
(lib.LogoAnimation = function(mode,startPosition,loop) {
	...
	this.nbn.setTransform(77.3,81.1,1.012,1.012,0,0,0,58.1,20.7);
	this.nbn.alpha = 0;
	...
	this.NBNlogo.setTransform(124.6,71.2,0.349,0.349,0,0,0,69.7,68.7);
	...
	this.NBNtrail.setTransform(153.1,61.1,0.477,0.477,0,0,0,8.3,29.1);
	...
	this.instance.parent = this;
	this.instance.setTransform(84.5,500.8);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},13,cjs.Ease.get(-0.99)).wait(21));
