...
(lib.nbn = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(107.2,34.7,2.653,2.653);
	...
	this.shape_1.setTransform(92.9,34.7,2.653,2.653);
	...
	this.shape_2.setTransform(77.9,34.5,2.653,2.653);
	...
	this.shape_3.setTransform(61.3,34.6,2.653,2.653);
	...
	this.shape_4.setTransform(48.7,34.6,2.653,2.653);
	...
	this.shape_5.setTransform(37.3,34.7,2.653,2.653);
	...
	this.shape_6.setTransform(21.9,34.7,2.653,2.653);
	...
	this.shape_7.setTransform(5.7,34.5,2.653,2.653);
	...
	this.shape_8.setTransform(43.2,12.9,1.877,1.877);
	...
	this.shape_9.setTransform(25.4,10.1,1.877,1.877);
	...
	this.shape_10.setTransform(7.6,12.9,1.877,1.877);
	...
	this.shape_11.setTransform(52.2,2.8,1.877,1.877);
	...
	this.shape_12.setTransform(48.8,2.8,1.877,1.877);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.nbn, new cjs.Rectangle(0.3,-0.9,111.9,42.6), null);
...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-4.3,42.8);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer 3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#133C7D").s().p("A0PDJQhkAAAAhkIAAjJQAAhkBkAAMAofAAAQBkAAAABkIAADJQAABkhkAAg");
	this.shape_1.setTransform(-4.6,41);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(-144.2,20.9,279.3,40.3), null);
...
(lib.LogoAnimation = function(mode,startPosition,loop) {
	...
	this.nbn.setTransform(141.4,83.2,1.262,1.262,0,0,0,58.1,20.7);
	this.nbn.alpha = 0;
	...
	this.NBNlogo.setTransform(205.4,70.9,0.435,0.435,0,0,0,70,69);
	...
	this.NBNtrail.setTransform(240.9,58.3,0.595,0.595,0,0,0,8.3,29.2);
	...
	this.instance.parent = this;
	this.instance.setTransform(154.5,508.6);
