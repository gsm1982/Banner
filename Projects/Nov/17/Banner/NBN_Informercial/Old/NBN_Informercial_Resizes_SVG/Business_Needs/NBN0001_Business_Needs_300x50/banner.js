...
function adVisibilityHandler() {
    ...
    TweenLite.delayedCall(12, frame4);
}
...
function frame2() {
    TweenLite.to("#copy1", 0.6, { alpha: 0, delay: 0.0, ease: Quad.easeIn});
...
function frame4() {
    TweenLite.to("#copy3, #img1", 0.6, { alpha: 0, delay: 0.0, ease: Quad.easeIn});
    TweenLite.to("#copy4", 0.6, { alpha: 1, delay: 0.6, ease: Quad.easeIn});
