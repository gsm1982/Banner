...
(lib.nbn = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(70.7,31.5,1.833,1.833);
	...
	this.shape_1.setTransform(61.3,31.5,1.833,1.833);
	...
	this.shape_2.setTransform(51.6,31.4,1.833,1.833);
	...
	this.shape_3.setTransform(40.6,31.5,1.833,1.833);
	...
	this.shape_4.setTransform(32.5,31.5,1.833,1.833);
	...
	this.shape_5.setTransform(25.2,31.5,1.833,1.833);
	...
	this.shape_6.setTransform(15,31.5,1.833,1.833);
	...
	this.shape_7.setTransform(4.2,31.4,1.833,1.833);
...
}).prototype = getMCSymbolPrototype(lib.nbn, new cjs.Rectangle(0,0,74.2,36.4), null);
...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-40.5,43.2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer 3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#133C7D").s().p("A0TDIQhkAAAAhkIAAjHQAAhkBkAAMAonAAAQBkAAAABkIAADHQAABkhkAAg");
	this.shape_1.setTransform(-39.4,42.4);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(-179.4,22.4,280,40), null);
...
(lib.LogoAnimation = function(mode,startPosition,loop) {
	...
	this.nbn.setTransform(84,61.9,0.818,0.818,0,0,0,58.2,20.8);
	this.nbn.alpha = 0;
	...
	this.NBNlogo.setTransform(81.4,34.4,0.246,0.246,0,0,0,69.6,69);
	...
	this.NBNtrail.setTransform(101.6,27.2,0.337,0.337,0,0,0,8.3,29.2);
