...
function adVisibilityHandler() {
    ...
    TweenLite.delayedCall(7, frame3);
    TweenLite.delayedCall(10.9, frame4);
    TweenLite.delayedCall(11.5, animateLogo)
}
...
function frame4() {
    ...
    TweenLite.to("#img4", 0.6, { alpha: 1, delay: 0.6, ease: Quad.easeIn});
}
