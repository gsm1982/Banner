...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	...
	// Layer 3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#133C7D").s().p("AqJDDQhkAAAAhkIAAi9QAAhkBkAAIUTAAQBkAAAABkIAAC9QAABkhkAAg");
	this.shape_1.setTransform(-4.4,40.9);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(-79.4,21.4,150,39), null);
