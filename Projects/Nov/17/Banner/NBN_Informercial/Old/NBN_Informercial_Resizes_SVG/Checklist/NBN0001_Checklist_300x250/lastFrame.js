(function (cjs, an) {
    ...
    (lib.LogoAnimation = function(mode,startPosition,loop) {
        ...
        this.nbn.setTransform(121.1,96.2,1.125,1.125,0,0,0,58,20.6);
        this.nbn.alpha = 0;
        ...
        this.NBNlogo.setTransform(117.6,58.4,0.339,0.339,0,0,0,69.2,68.4);
        ...
        this.NBNtrail.setTransform(145.3,48.7,0.463,0.463,0,0,0,8.1,28.9);
    ...
    p.nominalBounds = new cjs.Rectangle(149,126,302,290);
    // library properties:
    lib.properties = {
