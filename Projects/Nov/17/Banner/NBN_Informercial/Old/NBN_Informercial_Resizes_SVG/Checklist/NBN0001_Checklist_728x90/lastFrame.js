...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-2.4,40);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer 3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#133C7D").s().p("AsfDDQhkAAAAhkIAAi9QAAhkBkAAIY/AAQBkAAAABkIAAC9QAABkhkAAg");
	this.shape_1.setTransform(-2.7,40.4);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(-92.7,20.9,180,39), null);
...
p.nominalBounds = new cjs.Rectangle(394,62.1,666.8,57.5);
// library properties:
lib.properties = {
