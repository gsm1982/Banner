...
function prepareAssets() {
	...
	TweenMax.set("#logo", { x:"20", y:"538", autoAlpha: 1 });
    adVisibilityHandler();
}
...
function adVisibilityHandler() {
    ...
    TweenMax.delayedCall(8, animateLogo)
}
...
function frame3() {
    ...
    TweenMax.to("#img3", 0.6, { alpha: 1, delay: 0.3, ease: Quad.easeIn});
    // TweenMax.to("#copy3", 0.6, { alpha: 1, delay: 0.6, ease: Quad.easeInOut});
}
