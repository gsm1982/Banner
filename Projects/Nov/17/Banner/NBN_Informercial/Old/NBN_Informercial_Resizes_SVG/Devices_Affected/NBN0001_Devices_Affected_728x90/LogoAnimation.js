...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 4
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-72.8,57.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(255,255,255,0)").s().p("");
	this.shape_1.setTransform(-72.2,59.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	...
	// Layer 3
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#133C7D").s().p("A0WGQQhkAAAAhkIAApXQAAhkBkAAMAotAAAQBjAAAABkIAAJXQAABkhjAAg");
	this.shape_3.setTransform(-39.4,41.4);

	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(-179.7,1.4,280.5,80), null);
...
p.nominalBounds = new cjs.Rectangle(394,51,680.3,80);
// library properties:
lib.properties = {
