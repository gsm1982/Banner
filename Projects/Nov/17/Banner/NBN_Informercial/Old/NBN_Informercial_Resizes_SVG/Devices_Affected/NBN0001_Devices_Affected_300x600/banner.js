...
function adVisibilityHandler() {
    ...
    TweenMax.delayedCall(3.8, animateLogo)
}
...
function frame2() {
    TweenMax.to("#bg1", 0.5 ,{opacity:0, ease:Quad.easeOut});
		TweenMax.to("#copy1", 0.5 ,{alpha:0, ease:Quad.easeOut});
		TweenMax.to("#logo", 0.5 ,{alpha:0, ease:Quad.easeOut});
    TweenMax.to("#bg2", 0.5 ,{opacity:1, delay:0.5, ease:Quad.easeIn});
}
