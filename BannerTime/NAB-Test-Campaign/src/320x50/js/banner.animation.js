...
Banner.prototype.start = function () {
  ...
  this.images = [
    'images/320x50_copy1_2x.png',
    'images/320x50_copy2_2x.png',
    'images/320x50_copy3_2x.png',
    'images/320x50_cta_2x.png',
    'images/320x50_img1.jpg',
    'images/320x50_img2.jpg',
    'images/320x50_img3.jpg',
    'images/320x50_img4.jpg',
    'images/320x50_small_nbn_logo_2x.png'
  ];
...
Banner.prototype.createElements = function () {
  this.copy1 = this.smartObject({
    backgroundImage: 'images/320x50_copy1_2x.png',
    retina: true,
    parent: this.banner
  });

  this.copy2 = this.smartObject({
    backgroundImage: 'images/320x50_copy2_2x.png',
    retina: true,
    parent: this.banner
  });

  this.copy3 = this.smartObject({
    backgroundImage: 'images/320x50_copy3_2x.png',
    retina: true,
    parent: this.banner
  });

  this.cta = this.smartObject({
    backgroundImage: 'images/320x50_cta_2x.png',
    retina: true,
    parent: this.banner
  });

  this.img1 = this.smartObject({
    backgroundImage: 'images/320x50_img1.jpg',
    retina: true,
    parent: this.banner
  });

  this.img2 = this.smartObject({
    backgroundImage: 'images/320x50_img2.jpg',
    retina: true,
    parent: this.banner
  });

  this.img3 = this.smartObject({
    backgroundImage: 'images/320x50_img3.jpg',
    retina: true,
    parent: this.banner
  });

  this.img4 = this.smartObject({
    backgroundImage: 'images/320x50_img4.jpg',
    retina: true,
    parent: this.banner
  });

  this.smallLogo = this.smartObject({
    backgroundImage: 'images/320x50_small_nbn_logo_2x.png',
    retina: true,
    parent:this.banner
  });
};
