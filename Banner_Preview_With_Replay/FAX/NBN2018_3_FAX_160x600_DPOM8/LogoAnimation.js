...
(lib.LogoAnimation = function(mode,startPosition,loop) {
	...
	this.nbn.setTransform(77.3,101.1,1.012,1.012,0,0,0,58.1,20.7);
	this.nbn.alpha = 0;
	...
	this.NBNlogo.setTransform(124.6,91.2,0.349,0.349,0,0,0,69.7,68.7);
	...
	this.NBNtrail.setTransform(153.1,81.1,0.477,0.477,0,0,0,8.3,29.1);
