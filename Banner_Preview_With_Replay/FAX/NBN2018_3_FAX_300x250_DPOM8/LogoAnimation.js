...
(lib.nbn = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(64.6,29.1,1.666,1.666);
	...
	this.shape_1.setTransform(56,29.1,1.666,1.666);
	...
	this.shape_2.setTransform(47.3,28.9,1.666,1.666);
	...
	this.shape_3.setTransform(37.4,29.1,1.666,1.666);
	...
	this.shape_4.setTransform(30,29.1,1.666,1.666);
	...
	this.shape_5.setTransform(23.5,29.1,1.666,1.666);
	...
	this.shape_6.setTransform(14.2,29.1,1.666,1.666);
	...
	this.shape_7.setTransform(4.3,28.9,1.666,1.666);
	...
	this.shape_8.setTransform(39.2,13,1.66,1.66);
	...
	this.shape_9.setTransform(23.4,10.6,1.66,1.66);
	...
	this.shape_10.setTransform(7.2,13,1.66,1.66);
	...
	this.shape_11.setTransform(47.4,4.1,1.66,1.66);
	...
	this.shape_12.setTransform(44.4,4.1,1.66,1.66);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.nbn, new cjs.Rectangle(0.9,0.8,66.8,32.7), null);
...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-1.5,40.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer 3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#133C7D").s().p("AxLDHQhkAAAAhkIAAjFQAAhkBkAAMAiXAAAQBkAAAABkIAADFQAABkhkAAg");
	this.shape_1.setTransform(-1.7,39.5);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(-121.7,19.6,240,39.8), null);
...
(lib.LogoAnimation = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(33).call(this.frame_33).wait(34));

	// nbn
	this.nbn = new lib.nbn();
	this.nbn.parent = this;
	this.nbn.setTransform(107,99.4,1.24,1.24,0,0,0,58.1,20.7);
	this.nbn.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.nbn).to({_off:true},34).wait(33));

	// NBNLogo
	this.NBNlogo = new lib.NBNlogo();
	this.NBNlogo.parent = this;
	this.NBNlogo.setTransform(97,59.3,0.356,0.356,0,0,0,69.3,68.4);

	this.timeline.addTween(cjs.Tween.get(this.NBNlogo).to({_off:true},34).wait(33));

	// Trail
	this.NBNtrail = new lib.NBNtrail();
	this.NBNtrail.parent = this;
	this.NBNtrail.setTransform(126.2,49,0.486,0.486,0,0,0,8.2,28.9);

	this.timeline.addTween(cjs.Tween.get(this.NBNtrail).to({_off:true},34).wait(33));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({alpha:1},13,cjs.Ease.get(-0.99)).to({_off:true},1).wait(33));
