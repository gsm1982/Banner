...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-46.5,43.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer 3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#133C7D").s().p("Ax5DDQhkAAAAhkIAAi9QAAhkBkAAMAjzAAAQBkAAAABkIAAC9QAABkhkAAg");
	this.shape_1.setTransform(-46.3,42.1);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(-170.9,22.6,249.3,39), null);
...
(lib.LogoAnimation = function(mode,startPosition,loop) {
	...
	this.nbn.setTransform(84.7,61.8,0.818,0.818,0,0,0,58.2,20.8);
	this.nbn.alpha = 0;
