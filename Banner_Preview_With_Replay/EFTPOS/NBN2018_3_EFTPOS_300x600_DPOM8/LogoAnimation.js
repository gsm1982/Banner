...
(lib.LogoAnimation = function(mode,startPosition,loop) {
	...
	this.nbn.setTransform(141.4,107.2,1.262,1.262,0,0,0,58.1,20.7);
	this.nbn.alpha = 0;
	...
	this.NBNlogo.setTransform(205.4,94.9,0.435,0.435,0,0,0,70,69);
	...
	this.NBNtrail.setTransform(240.9,82.3,0.595,0.595,0,0,0,8.3,29.2);
