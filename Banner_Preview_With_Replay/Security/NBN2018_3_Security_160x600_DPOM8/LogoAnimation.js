...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-5,39.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(-4.6,19.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	// Layer 3
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#133C7D").s().p("AqFEtQhkAAAAhkIAAmRQAAhkBkAAIULAAQBkAAAABkIAAGRQAABkhkAAg");
	this.shape_2.setTransform(-4.6,30.1);

	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(-79.2,0,149.2,60.2), null);
...
(lib.LogoAnimation = function(mode,startPosition,loop) {
	...
	this.nbn.setTransform(77.3,91.1,1.012,1.012,0,0,0,58.1,20.7);
	this.nbn.alpha = 0;
	...
	this.NBNlogo.setTransform(124.6,81.2,0.349,0.349,0,0,0,69.7,68.7);
	...
	this.NBNtrail.setTransform(153.1,71.1,0.477,0.477,0,0,0,8.3,29.1);
	...
	this.instance.parent = this;
	this.instance.setTransform(84.5,519.6);
