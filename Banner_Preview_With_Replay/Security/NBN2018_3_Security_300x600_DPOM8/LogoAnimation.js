...
(lib.cta = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-4.1,22.6);
	...
	this.shape_1.setTransform(-4.1,21);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.cta, new cjs.Rectangle(-143.7,0.9,279.3,40.3), null);
...
(lib.LogoAnimation = function(mode,startPosition,loop) {
	...
	this.nbn.setTransform(141.4,84.2,1.262,1.262,0,0,0,58.1,20.7);
	this.nbn.alpha = 0;
	...
	this.NBNlogo.setTransform(205.4,71.9,0.435,0.435,0,0,0,70,69);
	...
	this.NBNtrail.setTransform(240.9,59.3,0.595,0.595,0,0,0,8.3,29.2);
...
p.nominalBounds = new cjs.Rectangle(150,301,300,600);
// library properties:
lib.properties = {
